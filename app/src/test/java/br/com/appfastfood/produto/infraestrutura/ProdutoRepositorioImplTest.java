...
public class ProdutoRepositorioImplTest {
    ...
    void testBuscarPorCategoria_CategoriaEncontrada() {
        ...
        produtoEntidades.add(new ProdutoEntidade("Produto 1", new BigDecimal("10.0"), "http://localhost:8080", "lanche", "Descrição do produto 1"));
        produtoEntidades.add(new ProdutoEntidade("Produto 2", new BigDecimal("20.0"), "http://localhost:8080", "lanche", "Descrição do produto 2"));
        ...
        Assertions.assertEquals(new BigDecimal("10.0"), produtos.get(0).getPreco().getPreco());
        ...
        Assertions.assertEquals(new BigDecimal("20.0"), produtos.get(1).getPreco().getPreco());
