...
//     @Test
//     public void criar_DeveRetornarStatus400_QuandoIDNaoEncontradoExceptionLancada() {
//         // Definir objetos de teste e comportamento do mock
//         PedidoRequisicao pedidoRequisicao = new PedidoRequisicao("1", "12345678999", BigDecimal.valueOf(10), "1"); 

//         // Configurar o comportamento do mock
//         //when(pedidoServicoMock.criar(any(PedidoEntidade.class))).thenThrow(pedidoRequisicao);
